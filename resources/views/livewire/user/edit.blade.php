        ...
        <div class="dialog-content">
            <div class="dialog-form">
                <div class="dialog-form-head">
                    <div class="text-h6 text-md-h4 text--center">Редактирование</div>
                </div>
                <div class="dialog-form-content">
                    ...
                    <label class="form-avatar-field">
                        <input wire:model="tmp_photo" type="file" hidden accept="image/*">
                        ...
                        <button wire:click="deletePhoto" class="btn btn--red btn--link ml-auto text-small text--demibold" data-remove>Удалить
                            фото</button>
                    </label>
                    <label class="form-field mt-5">
                        ...
                        <div class="form-input-cover">
                            <input wire:model="phone" type="tel" class="form-input" placeholder="+7">
                        </div>
                    </label>
                    ...
                    <div class="grid">
                        <div class="grid-col-sm-6">
                            ...
                            <label class="form-field form-checkbox mb-4">
                                <input wire:model="access" value="{{ $project->slug }}" type="checkbox" class="form-input-checkbox">
                    ...
                    <div class="flex mt-10">
                        <button wire:click="update" class="btn btn--primary btn--fill">Сохранить</button>
                        <button wire:click="cancel" class="btn btn--primary btn--light ml-2 ml-sm-4" type="button" data-fancybox-close>Отмена</button>
