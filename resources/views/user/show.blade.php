<x-app-layout>
    <div class="content-inner">
        <div class="flex flex-align-center mb-8">
            ...
            <button x-data="{ add() { Livewire.emit('userAddVisible') } }" x-on:click="add" class="btn btn--primary btn--fill btn-icon btn-large ml-auto">
                <svg class="icon">
                    <use xlink:href="{{ asset('img/icons.svg#user-plus') }}" />
                </svg>
            </button>
        </div>
