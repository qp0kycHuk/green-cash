<x-app-layout>
    <div class="content-inner">
        ...
        <div class="d-sm-flex mb-7">
            <div class="btn-group"><button class="btn btn-small btn--fill btn--primary px-0 px-sm-3 flex-grow"><span
                ...
                <div class="form-input-cover"><input class="form-input form-input-small pl-9 pr-1 text-small text--bold"
                        data-datepicker readonly="readonly">
        ...
        <div class="project-table">
            <div class="d-none d-lg-block">
                ...
                <div class="project-item__title flex flex-align-center"><img src="img/test-3.jpg" alt=""
                        class="icon text-h5 mr-3">
        ...
        <div class="project-table">
            ...
            </div><a href="javascript:;" class="project-row project-row--min project-item waved card card-action">
                <div class="project-item__title flex flex-align-center"><img src="img/test-3.jpg" alt=""
                        class="icon text-h5 mr-3">
                    <div class="text-body-2 text--demibold">dirijer-sada.ru</div>
                </div>
